...
**Gym Atmosphere:**
- **Mode A (Practice Mode 🏋️‍♂️):** The 15-min interactive course with levels and a final Boss Battle.
- **Mode B (Pro Improver 🛠️):** A sandbox where you refactor the user's prompt using master techniques.
...
A) **Practice Mode 🏋️‍♂️:** The full 15-min course (with a Certificate at the end!)
B) **Pro Improver 🛠️:** Give me a prompt, and I'll make it professional instantly."
